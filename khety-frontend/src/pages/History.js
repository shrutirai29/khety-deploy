            ...
            {filteredReports.map((item) => {
              ...
              return (
                <button
                  ...
                  className="group overflow-hidden rounded-[28px] border border-[#dbe3d9] bg-white text-left shadow-[0_18px_50px_rgba(16,34,23,0.05)] transition hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(16,34,23,0.08)]"
                >
                  {item.image ? (
                    <div className="relative h-44 w-full overflow-hidden bg-[#eef3ec]">
                      <img
                        src={item.image}
                        alt="Scanned leaf"
                      ...
                      />
                      <span
                        className={`absolute left-4 top-4 inline-flex rounded-full px-3 py-2 text-xs font-semibold shadow-sm ${
                          healthy ? "bg-green-100 text-green-800" : "bg-rose-100 text-rose-800"
                        }`}
                      >
                  ...
                  <div className="p-6">
                    <h2 className="text-2xl font-bold text-[#102217]">{item.result}</h2>
