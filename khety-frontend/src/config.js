...
const SITE_CONFIG = {
  ...
  supportEmail:
    process.env.REACT_APP_SUPPORT_EMAIL || "support@khety.in",
  supportPhone:
    process.env.REACT_APP_SUPPORT_PHONE || "+91 98765 43210",
  supportPhoneHref:
    process.env.REACT_APP_SUPPORT_PHONE_HREF || "+919876543210",
  supportHours:
